      ...
      <View style={{ paddingHorizontal: 5, paddingVertical: 10 }}>
        <View style={{ backgroundColor: "white", borderRadius: 5 }}>
          ...
          >
            <View>
              <Text
                style={[styles.text, { color: "#613EEA", fontWeight: "bold" }]}
              >
                Confirmed
              </Text>
            ...
            <View>
              <Text
                style={[styles.text, { color: "#32cd32", fontWeight: "bold" }]}
              >
                Recovered
              </Text>
            ...
            <View>
              <Text
                style={[styles.text, { color: "#EB5757", fontWeight: "bold" }]}
              >
                Deaths
              </Text>
              ...
              <View style={{ flexDirection: "row", alignItems: "center" }}>
                <View style={{ paddingVertical: 10 }}>
                  <Image
                    ...
                    style={{ width: 40, height: 30, marginHorizontal: 20 }}
                  />
                </View>
                <View>
  ...
  showModal = () => {
    return (
      <Modal visible={this.state.visible} style={{ flex: 1 }}>
        <View>
          {this.closeButton()}
          <ScrollView scrollEventThrottle={16}>{this.countryList()}</ScrollView>
        </View>
      </Modal>
    );
  };
          ...
          <View style={styles.container}>
            ...
            <View style={{ paddingHorizontal: 10, paddingVertical: 10 }}>
              <Text style={{ textAlign: "right" }}>
                {moment(lastupdated).format("ddd, MMMM DD YYYY")}
              </Text>
            </View>
            {this.showModal()}
          </View>
